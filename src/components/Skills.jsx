  ...
  return (
    <section id="skills" className="wrap">
      <div className="sec-head" data-reveal>
        <span className="sec-idx">04 — Skills</span>
        <h2 className="sec-title">Tool<em>kit.</em></h2>
        <p className="sec-sub">Backend-first, with enough cloud, DevOps and frontend to ship the whole thing.</p>
      </div>
      ...
      <div className="bento">
        ...
        <div className="cell now" style={{ "--span": 2 }} data-reveal>
